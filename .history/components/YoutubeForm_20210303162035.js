        ...
        <>
            ...
            <form className="mx-auto w-6xl">
                ...
                <div className="mb-5">
                    ...
                    <input type='email' id='email' name='email' className="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium border" />
                </div>
                
                <div className="mb-3">
                    <label htmlFor='channel' className="font-bold mb-1 text-gray-700 block">Channel</label>
                    <input type='text' id='channel' name='channel' className="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium border" />
                </div>
